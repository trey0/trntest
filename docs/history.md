...
## Phase 124 (2026-09-12) -- ISIS `shadow` cast-shadow spike (step 1) and a real GLD100 artifact found along the way
...
## Phase 125 (2026-09-13) -- ASP `sfs --model-shadows` as an alternate shadow mask: blocked, not just untried
