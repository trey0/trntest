...
class TrnTestImage(abc.ABC):
    ...
    def plot_overlay(self, title: str | None = None):
        ...
        to the clickable-toggle version (see its own docstring) before this class existed, and
        reverting that UX improvement here would be a real regression, not a neutral relocation.
