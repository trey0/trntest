...
# `wac_emp_edge_correction`'s fix for the archived WAC_EMP tiles' edge-brightening defect at their
# shared ±60 deg boundary, both hemispheres independently fit (see
# docs/proposed-tasks/open-items.md and notebooks/wac_emp_seam_correction.py). Set `False` to get the
