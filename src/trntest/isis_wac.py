...
def sample_local_dem_patch(
    ...
    # `hapke._terrain_photometric_angles`'s own gradient stencil, specifically so its output can be
    ...
    # `geo_utils.local_orthographic_crs`/`geographic_crs` already define elsewhere in this project --
