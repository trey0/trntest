...
def test_distort_is_a_small_near_identity_perturbation_for_small_inputs():
    ...
    # against campt (see docs/pose-alignment.md for that).
...
def test_fit_pose_correction_converges_to_near_zero_residual_on_synthetic_data():
    ...
    # docs/pose-alignment.md's jigsaw-singularity note -- so insisting on bit-exact
...
def test_find_framelet_and_project_round_trips_real_ground_points_through_real_campt():
    ...
    (docs/pose-alignment.md, "0.00m ground error... spanning the crop's full sample/line
